...
public final class FragmentDisplayBinding implements ViewBinding {
  ...
  private FragmentDisplayBinding(@NonNull LinearLayout rootView,
      @NonNull TextView textViewDisplay) {
  ...
  public static FragmentDisplayBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.textViewDisplay;
      TextView textViewDisplay = ViewBindings.findChildViewById(rootView, id);
      if (textViewDisplay == null) {
        break missingId;
      }

      return new FragmentDisplayBinding((LinearLayout) rootView, textViewDisplay);
    }
